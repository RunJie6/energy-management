    ...
    <div class="login">
      ...
      <el-form :model="ruleForm" :rules="rules" ref="formRef">
        ...
        <el-form-item prop="password">
          <el-input v-model="ruleForm.password" placeholder="请输入密码" prefix-icon="Lock" type="password"></el-input>
        </el-form-item>
        <el-form-item>
...
const rules = reactive<FormRules<RuleForm>>({
  ...
  { min: 4, max: 8, message: '用户名要求4-8位数字与字母组合', trigger: 'blur' },
  ],
  password:[
  { required: true, message: '用户名不能为空', trigger: 'blur' },
  ]
...
.bg{
  ...
  .login{
    ...
    position: absolute;
    top: 50%;
    margin-top: -200px;//高度＋padding 400px,要想居中回退一半 200px
    left: 10%;
    .logo{
      display: flex;
