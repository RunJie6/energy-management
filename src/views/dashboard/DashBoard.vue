      ...
      <el-card>
        ...
        <div class="equipment">
          ...
          <div class="item">
            ...
            <img src="@/assets/flash3.png" alt="" class="mt mb">
    ...
    <el-col :span="6">
      ...
      <el-card class="mt">
        ...
        <ul class="ranking-list">
          ...
          <li class="ranking-item">
            <span class="rank" style="background-color: rgb(40, 60, 240); color: #fff;">2</span>
          ...
          <li class="ranking-item">
            <span class="rank" style="background-color: rgb(220, 80, 30); color: #fff;">3</span>
